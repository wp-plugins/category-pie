...
Category Pie uses the Google Chart API. Google ensures that all code and data are processed and rendered in the browser. No data is sent to any server.

== Screenshots ==

1. Category Pie in full effect.
